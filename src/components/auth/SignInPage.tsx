          ...
          <Card className="rounded-3xl border-slate-200/70 bg-white/95 p-6 shadow-xl shadow-slate-900/10 dark:border-slate-800/70 dark:bg-slate-950/90">
            <form className="space-y-5 text-center" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 rounded-lg border border-transparent px-2 py-1 text-xs font-semibold uppercase tracking-wide text-slate-500 transition hover:border-slate-200 hover:text-slate-900 dark:text-slate-400 dark:hover:border-slate-700 dark:hover:text-white"
              ...
              <div className="flex flex-wrap items-center justify-between gap-1.5">
                <Link
                  href={landingRoot}
                  className="inline-flex items-center justify-center rounded-lg w-1/3 border border-slate-200 px-5 py-2 text-xs font-semibold uppercase tracking-wide text-slate-600 transition hover:border-slate-300 hover:text-slate-900 dark:border-slate-800 dark:text-slate-300 dark:hover:text-white"
                >
                  Cancel
                </Link>
                <Button type="submit" className="rounded-lg w-1/3 px-6">
                  Sign In
                </Button>

              </div>

              <div className="rounded-2xl border border-slate-200 bg-white/70 px-4 py-3 text-xs text-slate-600 dark:border-slate-800 dark:bg-slate-900/60 dark:text-slate-300">
                Tip: Select a role card to auto-fill credentials, then sign in with the demo password.
              </div>
              ...
              <div className="grid gap-3 text-left sm:grid-cols-2">
                <div className="rounded-2xl border border-slate-200 bg-white/70 px-4 py-3 text-xs text-slate-600 dark:border-slate-800 dark:bg-slate-900/60 dark:text-slate-300">
                  ...
                  <p className="mt-2 text-xs">
                    Demo credentials are stored locally. Replace with server auth before launch.
                  </p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-white/70 px-4 py-3 text-xs text-slate-600 dark:border-slate-800 dark:bg-slate-900/60 dark:text-slate-300">
                  <p className="text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">
                  ...
                  <p className="mt-2 text-xs">
                    Reach out to <span className="font-semibold">hello@hrms.studio</span> for demo access.
                  </p>
                </div>
              </div>
            </form>
